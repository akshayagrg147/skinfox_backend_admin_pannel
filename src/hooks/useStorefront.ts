...
export type CareFinderApi = { id: string; name: string; questions: Array<{ id: string; key: string; prompt: string; sortOrder: number; options: Array<{ id: string; value: string; label: string; description?: string }> }> }
