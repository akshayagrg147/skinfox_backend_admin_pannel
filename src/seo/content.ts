...
export const defaultFaqs: FaqEntry[] = [
  ...
  { question: 'When will product prices be revealed?', answer: 'Product sizes and pack details are available now. Final prices will be revealed before purchase. Priority waitlist members receive early access to the member launch price associated with their confirmed reservation.' },
