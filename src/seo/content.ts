...
export const guidePages = [
  ...
  { slug: 'how-much-sunscreen-to-apply-on-face', title: 'How Much Sunscreen Should You Apply on Your Face?', excerpt: 'A label-first guide to building a consistent facial sun-care habit with an SPF 50 sunscreen.', sections: [{ heading: 'Start with the approved label', body: 'Sunscreen directions can vary by formula and region. Use the amount and reapplication guidance printed on your final pack rather than relying on a generic online estimate.' }, { heading: 'Make it a daily routine', body: 'Keep your sunscreen where you will remember it, apply it as directed and reapply when the label recommends. SkinFox’s Rayyvia page explains the product format without replacing its pack directions.' }] },
  { slug: 'moisturiser-for-winter-dry-skin', title: 'How to Choose a Moisturiser for Winter Dry Skin', excerpt: 'A practical guide to comparing lotion formats for dry and ultra-dry skin during colder, drier weather.', sections: [{ heading: 'Look for a format you will use', body: 'A pump lotion can make everyday use easy, while a larger tube can suit a focused body-care routine. Compare the pack size and texture notes, then read the approved label.' }, { heading: 'Keep claims realistic', body: 'A moisturiser can be part of a cosmetic care routine, but persistent, painful or unusual symptoms need a qualified healthcare professional rather than a product page.' }] },
]
