...
async function main() {
  ...
  await prisma.storeSetting.upsert({ where: { key: 'storefront' }, update: { value: { storeName: 'SkinFox', logo: '/brand/skinfox-logo.png', currency: 'INR', freeShippingThresholdPaise: 200000, announcement: 'New collection preview', supportEmail: 'hello@skinfox.example' } }, create: { key: 'storefront', value: { storeName: 'SkinFox', logo: '/brand/skinfox-logo.png', currency: 'INR', freeShippingThresholdPaise: 200000, announcement: 'New collection preview', supportEmail: 'hello@skinfox.example' } } })
