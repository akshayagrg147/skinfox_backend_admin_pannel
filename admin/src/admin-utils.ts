...
const screenAccess: Record<AdminRole, string[]> = {
  SUPER_ADMIN: ['dashboard', 'products', 'catalogue', 'inventory', 'orders', 'customers', 'affiliates', 'campaigns', 'content', 'care-finder', 'promotions', 'shipping', 'analytics', 'users', 'audit', 'settings'],
  ...
  SUPPORT_AGENT: ['orders', 'customers'],
